 ...
 */
function nus_custom_colors_css() {
	...
	/**
	 * Filter NUS Base default saturation level.
	 *
	 * @since NUS Base 1.0
	 *
	...
	$saturation          = absint( apply_filters( 'nus_custom_colors_saturation', 100 ) );
	$saturation          = $saturation . '%';

	$lightness           = absint( apply_filters( 'nus_custom_colors_lightness', 33 ) );
	$lightness           = $lightness . '%';

	$lightness_hover     = absint( apply_filters( 'nus_custom_colors_lightness_hover', 23 ) );
	$lightness_hover     = $lightness_hover . '%';

	$lightness_selection = absint( apply_filters( 'nus_custom_colors_lightness_selection', 90 ) );
	...
	/**
	 * Filters NUS Base custom colors CSS.
	 *
	 * @since NUS Base 1.0
	 *
	 ...
	 */
	return apply_filters( 'nus_custom_colors_css', $css, $primary_color, $saturation );
}
